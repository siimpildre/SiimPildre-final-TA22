...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-black text-white/50 relative">
    <img id="background" class="absolute inset-0 w-auto h-full object-cover object-center lg:w-full lg:top-0 lg:left-0 z-10" src="{{ asset('pictures/banner_opacity.png') }}" alt="Basketball Banner" />
    <img id="background2" class="absolute inset-x-0 bottom-full w-auto h-full object-cover object-center lg:w-full lg:left-0 z-10" src="{{ asset('pictures/balls_opacity.png') }}" alt="Basketballs in basket" />
        <div class="relative min-h-screen flex flex-col items-center justify-center ">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="">
                    <div class="grid grid-cols-2 items-center justify-between gap-2 pb-10 lg:pb-10 lg:grid-cols-2">
                    ...
                    <div class="flex py-2 lg:pt-20 justify-center">
                ...
                <main class="inset-x-0 top-full bg-black h-screen">
                @php
                ...
                @endphp
                    ...
                    <div class="max-h-[500px] overflow-y-auto relative bg-ball-basket">
